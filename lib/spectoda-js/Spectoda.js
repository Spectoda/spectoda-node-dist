...
class Spectoda {
    ...
    constructor(connectorType = "default", reconnectionInterval = 1000, runOnServer = false) {
        ...
        this.interface.onDisconnected = event => {
            ...
            if (this.#connectionState === "connected" && this.#reconnectionInterval) {
                Logging_js_1.logging.info(`Reconnecting device in ${TIME}ms`);
                this.#setConnectionState("connecting");
                setTimeout(() => {
                    Logging_js_1.logging.info("Reconnecting device...");
    ...
    #connect(autoConnect) {
        ...
        return (autoConnect ? this.interface.autoSelect(this.#criteria) : this.interface.userSelect(this.#criteria))
            .then(() => {
            Logging_js_1.logging.info("> Connecting to device...");
            ...
            return this.requestTimeline().catch(e => {
                ...
                .then(() => {
                Logging_js_1.logging.info("> Requesting event history...");

...
exports.SpectodaInterfaceLegacy = exports.COMMAND_FLAGS = void 0;
const Logging_js_1 = require("./Logging.js");
const functions_js_1 = require("./functions.js");
const SpectodaDummyConnector_js_1 = require("./SpectodaDummyConnector.js");
const SpectodaWebBluetoothConnector_js_1 = require("./SpectodaWebBluetoothConnector.js");
const SpectodaWebSerialConnector_js_1 = require("./SpectodaWebSerialConnector.js");
...
const FlutterConnector_js_1 = require("./FlutterConnector.js");
const i18n_js_1 = require("./i18n.js");
const SpectodaNodeBleConnector_1 = require("./SpectodaNodeBleConnector");
exports.COMMAND_FLAGS = Object.freeze({
    FLAG_UNSUPPORTED_COMMND_RESPONSE: 255,
    // legacy FW update flags
    FLAG_OTA_BEGIN: 255,
    FLAG_OTA_WRITE: 0,
    FLAG_OTA_END: 254,
    FLAG_OTA_RESET: 253,
    FLAG_DEVICE_REBOOT_REQUEST: 5,
...
class SpectodaInterfaceLegacy {
    ...
    constructor(deviceReference, reconnectionInterval = 1000) {
        ...
        this.clock = new TimeTrack_js_1.TimeTrack(0);
        ...
        this.#eventEmitter = (0, functions_js_1.createNanoEvents)();
        this.#wakeLock = null;
        ...
        this.#eventEmitter.on("ota_progress", value => {
            ...
            Logging_js_1.logging.verbose("time_delta:", time_delta);
            this.lastUpdateTime = now;
            const percentage_delta = value - this.lastUpdatePercentage;
            Logging_js_1.logging.verbose("percentage_delta:", percentage_delta);
            this.lastUpdatePercentage = value;
            const percentage_left = 100.0 - value;
            Logging_js_1.logging.verbose("percentage_left:", percentage_left);
            const time_left = (percentage_left / percentage_delta) * time_delta;
            Logging_js_1.logging.verbose("time_left:", time_left);
            ...
            /** @type {HTMLBodyElement} */ document.querySelector("body").addEventListener("click", function (e) {
                ...
                for (let el of path) {
                    if (el.tagName === "A" && el.getAttribute("target") === "_blank") {
                        ...
                        Logging_js_1.logging.verbose(url);
                        // @ts-ignore
                        Logging_js_1.logging.debug("Openning external url", url);
    ...
    requestWakeLock() {
        Logging_js_1.logging.debug("> Activating wakeLock...");
        if ((0, functions_js_1.detectSpectodaConnect)()) {
            return window.flutter_inappwebview.callHandler("setWakeLock", true);
        }
        else {
            return functions_js_1.noSleep.enable();
        }
    }
    releaseWakeLock() {
        Logging_js_1.logging.debug("> Deactivating wakeLock...");
        if ((0, functions_js_1.detectSpectodaConnect)()) {
            return window.flutter_inappwebview.callHandler("setWakeLock", false);
        }
        else {
            functions_js_1.noSleep.disable();
    ...
    assignConnector(connector_type = "default") {
        ...
        Logging_js_1.logging.info(`> Assigning ${connector_type} connector...`);
        if ((!this.connector && connector_type === "none") || (this.connector && this.connector.type === connector_type)) {
            Logging_js_1.logging.warn("Trying to reassign current connector.");
            return Promise.resolve();
        }
        ...
        return (this.connector ? this.destroyConnector() : Promise.resolve())
            ...
            switch (connector_type) {
                case "none":
                    ...
                    break;
                case "dummy":
                    this.connector = new SpectodaDummyConnector_js_1.SpectodaDummyConnector(this, false);
                    break;
                case "vdummy":
                    return (window
                        // @ts-ignore
                        ...
                        // @ts-ignore
                        .then(version => {
                        this.connector = new SpectodaDummyConnector_js_1.SpectodaDummyConnector(this, false, version);
                    }));
                case "edummy":
                    this.connector = new SpectodaDummyConnector_js_1.SpectodaDummyConnector(this, true);
                    break;
                case "webbluetooth":
                    if (((0, functions_js_1.detectAndroid)() && (0, functions_js_1.detectChrome)()) || ((0, functions_js_1.detectMacintosh)() && (0, functions_js_1.detectChrome)()) || ((0, functions_js_1.detectWindows)() && (0, functions_js_1.detectChrome)()) || ((0, functions_js_1.detectLinux)() && (0, functions_js_1.detectChrome)())) {
                        this.connector = new SpectodaWebBluetoothConnector_js_1.SpectodaWebBluetoothConnector(this);
                    }
                    else {
                        // iPhone outside Bluefy and SpectodaConnect
                        if ((0, functions_js_1.detectIPhone)()) {
                            // @ts-ignore
                            window.confirm((0, i18n_js_1.t)("Z tohoto webového prohlížeče bohužel není možné NARU ovládat. Prosím, stáhněte si aplikaci Spectoda Connect."), (0, i18n_js_1.t)("Prohlížeč není podporován")).then(result => {
                                if (result) {
                        ...
                        else if ((0, functions_js_1.detectMacintosh)()) {
                            // @ts-ignore
                            window.confirm((0, i18n_js_1.t)("Z tohoto webového prohlížeče bohužel není možné NARU ovládat. Prosím, otevřete aplikace v prohlížeči Google Chrome."), (0, i18n_js_1.t)("Prohlížeč není podporován")).then(result => {
                                if (result) {
                        ...
                        else if ((0, functions_js_1.detectAndroid)()) {
                            // @ts-ignore
                            window.confirm((0, i18n_js_1.t)("Z tohoto webového prohlížeče bohužel není možné NARU ovládat. Prosím, stáhněte si aplikaci Spectoda Connect."), (0, i18n_js_1.t)("Prohlížeč není podporován")).then(result => {
                                if (result) {
                                    // redirect na Google Chrome
                        ...
                        else if ((0, functions_js_1.detectWindows)()) {
                            // @ts-ignore
                            window.confirm((0, i18n_js_1.t)("Z tohoto webového prohlížeče bohužel není možné NARU ovládat. Prosím, otevřete aplikace v prohlížeči Google Chrome."), (0, i18n_js_1.t)("Prohlížeč není podporován")).then(result => {
                                if (result) {
                                    // redirect na Google Chrome
                        ...
                        // Linux ChromeBooks atd...
                            ...
                            window.confirm((0, i18n_js_1.t)("Z tohoto webového prohlížeče bohužel nejspíš není možné NARU ovládat."));
                        }
                        Logging_js_1.logging.error("Error: Assigning unsupported connector");
                        this.connector = null;
                    }
                    break;
                case "nodebluetooth":
                    this.connector = new SpectodaNodeBleConnector_1.SpectodaNodeBluetoothConnector(this);
                    break;
                case "webserial":
                    if ((0, functions_js_1.detectChrome)()) {
                        this.connector = new SpectodaWebSerialConnector_js_1.SpectodaWebSerialConnector(this);
                    }
                    else {
                        Logging_js_1.logging.error("Error: Assigning unsupported connector");
                        this.connector = null;
                    ...
                    break;
                case "flutter":
                    if ((0, functions_js_1.detectSpectodaConnect)() || (0, functions_js_1.detectWindows)() || (0, functions_js_1.detectMacintosh)()) {
                        this.connector = new FlutterConnector_js_1.FlutterConnector(this);
                    }
                    else {
                        Logging_js_1.logging.error("Error: Assigning unsupported connector");
                        this.connector = null;
                ...
                case "websockets":
                    ...
                    break;
                default:
                    Logging_js_1.logging.warn("Selected unknown connector");
    ...
    userSelect(criteria, timeout = 600000) {
        // this.#reconection = false;
        if (timeout < 1000) {
            Logging_js_1.logging.error("Timeout is too short.");
        ...
        Logging_js_1.logging.debug(`userSelect(criteria=${JSON.stringify(criteria)}, timeout=${timeout}`);
    ...
    autoSelect(criteria, scan_period = 4000, timeout = 10000) {
        ...
        Logging_js_1.logging.debug(`autoSelect(criteria=${JSON.stringify(criteria)}, scan_period=${scan_period}, timeout=${timeout}`);
    ...
    scan(criteria, scan_period = 5000) {
        // this.#reconection = false;
        if (scan_period < 1000) {
            Logging_js_1.logging.error("Scan period is too short.");
    ...
    #onConnected = event => {
        if (this.#connectGuard) {
            Logging_js_1.logging.error("Connecting logic error. #connected called when already connected?");
            Logging_js_1.logging.warn("Ignoring the #connected event");
            return;
        }
    ...
    #onDisconnected = event => {
        if (!this.#connectGuard) {
            Logging_js_1.logging.error("Connecting logic error. #disconnected called when already disconnected?");
            Logging_js_1.logging.warn("Ignoring the #disconnected event");
            return;
        }
        this.#connectGuard = false;
        this.onDisconnected(event);
        if (this.#reconection && this.#reconnectionInterval) {
            Logging_js_1.logging.info("> Reconnecting Device in 2s ...");
            setTimeout(() => {
                Logging_js_1.logging.debug("Reconnecting device");
                return this.connect(this.#reconnectionInterval).catch(() => {
                    Logging_js_1.logging.warn("Reconnection failed.");
                });
            }, 2000);
        }
    ...
    execute(bytes, bytes_label, timeout = 5000) {
        ...
        Logging_js_1.logging.verbose("execute", { bytes, bytes_label, timeout });
    ...
    request(bytes, read_response = true, timeout = 5000) {
        ...
        Logging_js_1.logging.verbose("request", { bytes, read_response, timeout });
    ...
    syncClock() {
        ...
        return item.promise.then(clock => {
            Logging_js_1.logging.debug(`Clock synchronized at time=${clock.millis()}ms`);
            this.clock = clock;
        });
    }
    // getClock() {
    ...
    #process(item) {
        ...
        if (!this.#processing) {
            ...
            (async () => {
                await (0, functions_js_1.sleep)(0.001); // short delay to let fill up the queue to merge the execute items if possible
                try {
                    while (this.#queue.length > 0) {
                        const item = this.#queue.shift();
                        if (this.connector === null || this.connector === undefined) {
                            Logging_js_1.logging.warn("Trying to do something while connector is not assigned");
                        ...
                        switch (item.type) {
                            ...
                            case Query.TYPE_CONNECT:
                                ...
                                Logging_js_1.logging.verbose("TYPE_CONNECT begin");
                                await this.connector
                                    .connect(item.a, item.b) // a = timeout, b = supportLegacy
                                    .then(device => {
                                    Logging_js_1.logging.debug("> Device connected");
                                    if (!this.#connectGuard) {
                                        Logging_js_1.logging.error("Connection logic error. #connected not called during successful connect()?");
                                        Logging_js_1.logging.warn("Emitting #connected");
                                        this.#eventEmitter.emit("#connected");
                                    }
                                    Logging_js_1.logging.debug("> Requesting clock");
                                    return (this.connector
                                        .getClock()
                                        .then(clock => {
                                        this.clock = clock;
                            ...
                            case Query.TYPE_EXECUTE:
                                ...
                                Logging_js_1.logging.debug("EXECUTE", (0, functions_js_1.uint8ArrayToHexString)(data));
                            ...
                            case Query.TYPE_REQUEST:
                                ...
                                Logging_js_1.logging.debug("REQUEST", (0, functions_js_1.uint8ArrayToHexString)(item.a));
                            ...
                            case Query.TYPE_DESTROY:
                                this.#reconection = false;
                                await this.connector
                                    .request([exports.COMMAND_FLAGS.FLAG_DEVICE_DISCONNECT_REQUEST], false)
                                    .catch(() => { })
                                    .then(() => {
                                    return this.connector.disconnect();
                                })
    ...
    process(bytecode) {
        ...
        let reader = new TnglReader_js_1.TnglReader(bytecode);
        const utc_timestamp = new Date().getTime();
        Logging_js_1.logging.verbose(reader);
        let emitted_events = [];
        while (reader.available > 0) {
            switch (reader.peekFlag()) {
                case exports.COMMAND_FLAGS.FLAG_REINTERPRET_TNGL:
                    {
                        Logging_js_1.logging.verbose("FLAG_REINTERPRET_TNGL");
                        ...
                        Logging_js_1.logging.verbose(`tngl_size=${tngl_size}`);
                        //logging.debug("bytecode_offset=%u", bytecode_offset);
                        // Runtime::feed(reader, bytecode_offset, tngl_size);
                    }
                    break;
                case exports.COMMAND_FLAGS.FLAG_EMIT_EVENT:
                case exports.COMMAND_FLAGS.FLAG_EMIT_TIMESTAMP_EVENT:
                case exports.COMMAND_FLAGS.FLAG_EMIT_COLOR_EVENT:
                case exports.COMMAND_FLAGS.FLAG_EMIT_PERCENTAGE_EVENT:
                case exports.COMMAND_FLAGS.FLAG_EMIT_LABEL_EVENT:
                    {
                        // let is_lazy = false;
                        ...
                        switch (reader.readFlag()) {
                            ...
                            //   is_lazy = true;
                            case exports.COMMAND_FLAGS.FLAG_EMIT_EVENT:
                                Logging_js_1.logging.verbose("FLAG_EVENT");
                                event_value = null;
                                event_type = "none";
                                break;
                            ...
                            //   is_lazy = true;
                            case exports.COMMAND_FLAGS.FLAG_EMIT_TIMESTAMP_EVENT:
                                Logging_js_1.logging.verbose("FLAG_TIMESTAMP_EVENT");
                            ...
                            //   is_lazy = true;
                            case exports.COMMAND_FLAGS.FLAG_EMIT_COLOR_EVENT:
                                Logging_js_1.logging.verbose("FLAG_COLOR_EVENT");
                                const bytes = reader.readBytes(3);
                                event_value = (0, functions_js_1.rgbToHex)(bytes[0], bytes[1], bytes[2]);
                                event_type = "color";
                                break;
                            // case COMMAND_FLAGS.FLAG_EMIT_LAZY_PERCENTAGE_EVENT:
                            //   is_lazy = true;
                            case exports.COMMAND_FLAGS.FLAG_EMIT_PERCENTAGE_EVENT:
                                Logging_js_1.logging.verbose("FLAG_PERCENTAGE_EVENT");
                                event_value = Math.round((0, functions_js_1.mapValue)(reader.readInt32(), -268435455, 268435455, -100, 100) * 1000000.0) / 1000000.0;
                            ...
                            //   is_lazy = true;
                            case exports.COMMAND_FLAGS.FLAG_EMIT_LABEL_EVENT:
                                Logging_js_1.logging.verbose("FLAG_LABEL_EVENT");
                        ...
                        Logging_js_1.logging.verbose(`event_value = ${event_value}`);
                        const event_label = String.fromCharCode(...reader.readBytes(5)).match(/[\w\d_]*/g)[0]; // 5 bytes
                        Logging_js_1.logging.verbose(`event_label = ${event_label}`);
                        const event_timestamp = reader.readUint48(); // 6 bytes in 0.9
                        Logging_js_1.logging.verbose(`event_timestamp = ${event_timestamp} ms`);
                        const event_device_id = reader.readUint8(); // 1 byte
                        Logging_js_1.logging.verbose(`event_device_id = ${event_device_id}`);
                        emitted_events.push({
                            type: event_type,
                            value: event_value,
                            label: event_label,
                    ...
                    break;
                case exports.COMMAND_FLAGS.FLAG_SET_TIMELINE:
                    {
                        Logging_js_1.logging.verbose("FLAG_SET_TIMELINE");
                        ...
                        Logging_js_1.logging.verbose(`clock_timestamp = ${clock_timestamp} ms`);
                        Logging_js_1.logging.verbose(`timeline_timestamp = ${timeline_timestamp} ms`);
                        Logging_js_1.logging.verbose(`timeline_flags = ${timeline_flags}`);
                        const timeline_paused = timeline_flags & PAUSED_FLAG ? true : false;
                        Logging_js_1.logging.verbose(`timeline_paused = ${timeline_paused ? "true" : "false"}`);
                        if (timeline_paused) {
                    ...
                    break;
                case exports.COMMAND_FLAGS.FLAG_PEER_CONNECTED:
                    {
                        Logging_js_1.logging.verbose("FLAG_PEER_CONNECTED");
                    ...
                    break;
                case exports.COMMAND_FLAGS.FLAG_PEER_DISCONNECTED:
                    {
                        Logging_js_1.logging.verbose("FLAG_PEER_DISCONNECTED");
                    ...
                    break;
                // // request land
                case exports.COMMAND_FLAGS.FLAG_OTA_BEGIN:
                    {
                        Logging_js_1.logging.verbose("FLAG_OTA_BEGIN");
                    ...
                    break;
                case exports.COMMAND_FLAGS.FLAG_OTA_WRITE:
                    {
                        Logging_js_1.logging.verbose("FLAG_OTA_WRITE");
                    ...
                    break;
                case exports.COMMAND_FLAGS.FLAG_OTA_END:
                    {
                        Logging_js_1.logging.verbose("FLAG_OTA_END");
                    ...
                    break;
                case exports.COMMAND_FLAGS.FLAG_OTA_RESET:
                    {
                        Logging_js_1.logging.verbose("FLAG_OTA_RESET");
                    ...
                    break;
                default:
                    Logging_js_1.logging.error(`ERROR flag=${reader.readFlag()}, available=${reader.available}`);
                    reader.forward(reader.available);
                    break;
            }
        }
        if (emitted_events.length) {
            ...
            Logging_js_1.logging.info(informations.join("\n"));
        }
    }
}
exports.SpectodaInterfaceLegacy = SpectodaInterfaceLegacy;
//////////////

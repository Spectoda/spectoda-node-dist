...
var wasmBinaryFile;
wasmBinaryFile = "RELEASE_0.9.0_20230309.wasm";
...
function createWasm() { var info = { "a": asmLibraryArg }; function receiveInstance(instance, module) { var exports = instance.exports; Module["asm"] = exports; wasmMemory = Module["asm"]["na"]; updateGlobalBufferAndViews(wasmMemory.buffer); wasmTable = Module["asm"]["ra"]; addOnInit(Module["asm"]["oa"]); removeRunDependency("wasm-instantiate"); } addRunDependency("wasm-instantiate"); function receiveInstantiationResult(result) { receiveInstance(result["instance"]); } function instantiateArrayBuffer(receiver) { return getBinaryPromise().then(function (binary) { return WebAssembly.instantiate(binary, info); }).then(function (instance) { return instance; }).then(receiver, function (reason) { err("failed to asynchronously prepare wasm: " + reason); abort(reason); }); } function instantiateAsync() { if (!wasmBinary && typeof WebAssembly.instantiateStreaming == "function" && !isDataURI(wasmBinaryFile) && !isFileURI(wasmBinaryFile) && !ENVIRONMENT_IS_NODE && typeof fetch == "function") {
...
function emval_allocateDestructors(destructorsRef) { var destructors = []; HEAPU32[destructorsRef >> 2] = Emval.toHandle(destructors); return destructors; }
var emval_symbols = {};
...
var asmLibraryArg = { "A": ___assert_fail, "k": ___cxa_begin_catch, "r": ___cxa_end_catch, "a": ___cxa_find_matching_catch_2, "f": ___cxa_find_matching_catch_3, "B": ___cxa_rethrow, "j": ___cxa_throw, "e": ___resumeException, "F": ___syscall_fcntl64, "W": ___syscall_ioctl, "X": ___syscall_openat, "ka": __embind_create_inheriting_constructor, "R": __embind_register_bigint, "aa": __embind_register_bool, "y": __embind_register_class, "J": __embind_register_class_class_function, "ma": __embind_register_class_constructor, "l": __embind_register_class_function, "$": __embind_register_emval, "z": __embind_register_enum, "q": __embind_register_enum_value, "H": __embind_register_float, "p": __embind_register_integer, "n": __embind_register_memory_view, "G": __embind_register_std_string, "w": __embind_register_std_wstring, "ba": __embind_register_void, "Z": __emscripten_get_now_is_monotonic, "da": __emval_as, "x": __emval_call_method, "I": __emval_call_void_method, "la": __emval_decref, "s": __emval_get_method_caller, "ea": __emval_get_property, "K": __emval_incref, "ja": __emval_new_array, "t": __emval_new_cstring, "ia": __emval_new_object, "ga": __emval_run_destructors, "ha": __emval_set_property, "L": __emval_take_value, "v": _abort, "Y": _emscripten_get_now, "_": _emscripten_memcpy_big, "U": _emscripten_resize_heap, "D": _fd_close, "V": _fd_read, "Q": _fd_seek, "E": _fd_write, "ca": invoke_diii, "M": invoke_i, "c": invoke_ii, "g": invoke_iii, "o": invoke_iiii, "m": invoke_iiiii, "O": invoke_iiiiii, "C": invoke_iiiiiiii, "fa": invoke_iiiiiiiiii, "P": invoke_j, "T": invoke_ji, "i": invoke_v, "b": invoke_vi, "d": invoke_vii, "h": invoke_viii, "u": invoke_viiii, "S": invoke_viiiji, "N": _llvm_eh_typeid_for };
var asm = createWasm();
var ___wasm_call_ctors = Module["___wasm_call_ctors"] = function () { return (___wasm_call_ctors = Module["___wasm_call_ctors"] = Module["asm"]["oa"]).apply(null, arguments); };
var _free = Module["_free"] = function () { return (_free = Module["_free"] = Module["asm"]["pa"]).apply(null, arguments); };
var _malloc = Module["_malloc"] = function () { return (_malloc = Module["_malloc"] = Module["asm"]["qa"]).apply(null, arguments); };
var ___cxa_free_exception = Module["___cxa_free_exception"] = function () { return (___cxa_free_exception = Module["___cxa_free_exception"] = Module["asm"]["sa"]).apply(null, arguments); };
var _main = Module["_main"] = function () { return (_main = Module["_main"] = Module["asm"]["ta"]).apply(null, arguments); };
var ___getTypeName = Module["___getTypeName"] = function () { return (___getTypeName = Module["___getTypeName"] = Module["asm"]["ua"]).apply(null, arguments); };
...
var setTempRet0 = Module["setTempRet0"] = function () { return (setTempRet0 = Module["setTempRet0"] = Module["asm"]["ya"]).apply(null, arguments); };
var stackSave = Module["stackSave"] = function () { return (stackSave = Module["stackSave"] = Module["asm"]["za"]).apply(null, arguments); };
var stackRestore = Module["stackRestore"] = function () { return (stackRestore = Module["stackRestore"] = Module["asm"]["Aa"]).apply(null, arguments); };
...
var ___cxa_is_pointer_type = Module["___cxa_is_pointer_type"] = function () { return (___cxa_is_pointer_type = Module["___cxa_is_pointer_type"] = Module["asm"]["Ca"]).apply(null, arguments); };
var dynCall_ji = Module["dynCall_ji"] = function () { return (dynCall_ji = Module["dynCall_ji"] = Module["asm"]["Da"]).apply(null, arguments); };
var dynCall_viiiji = Module["dynCall_viiiji"] = function () { return (dynCall_viiiji = Module["dynCall_viiiji"] = Module["asm"]["Ea"]).apply(null, arguments); };
var dynCall_iiiij = Module["dynCall_iiiij"] = function () { return (dynCall_iiiij = Module["dynCall_iiiij"] = Module["asm"]["Fa"]).apply(null, arguments); };
var dynCall_jiji = Module["dynCall_jiji"] = function () { return (dynCall_jiji = Module["dynCall_jiji"] = Module["asm"]["Ga"]).apply(null, arguments); };
var dynCall_j = Module["dynCall_j"] = function () { return (dynCall_j = Module["dynCall_j"] = Module["asm"]["Ha"]).apply(null, arguments); };
...
function callMain(args) { var entryFunction = Module["_main"]; var argc = 0; var argv = 0; try {

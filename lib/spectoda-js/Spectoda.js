...
class Spectoda {
    ...
    connect(devices = null, autoConnect = true, ownerSignature = null, ownerKey = null, connectAny = false, fwVersion = "", infiniteReconnection = false, overrideConnection = false) {
        Logging_js_1.logging.debug(`connect(devices=${devices}, autoConnect=${autoConnect}, ownerSignature=${ownerSignature}, ownerKey=${ownerKey}, connectAny=${connectAny}, fwVersion=${fwVersion}, infiniteReconnection=${infiniteReconnection}, overrideConnection=${overrideConnection})`);
    ...
    writeOwner(ownerSignature = "00000000000000000000000000000000", ownerKey = "00000000000000000000000000000000") {
        Logging_js_1.logging.debug("> Writing owner to device...");
    ...
    writeNetworkOwner(ownerSignature = "00000000000000000000000000000000", ownerKey = "00000000000000000000000000000000") {
        Logging_js_1.logging.debug("> Writing owner to network...");
        const owner_signature_bytes = (0, functions_js_1.hexStringToUint8Array)(ownerSignature, 16);
        const owner_key_bytes = (0, functions_js_1.hexStringToUint8Array)(ownerKey, 16);
        Logging_js_1.logging.info("owner_signature_bytes", owner_signature_bytes);
        Logging_js_1.logging.info("owner_key_bytes", owner_key_bytes);

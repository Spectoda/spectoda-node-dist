...
exports.unknownError = exports.general = exports.studio = exports.nara = void 0;
const i18n_1 = require("../i18n");
// Errors specific for NARA
exports.nara = {
    MicAccessDenied: {
        title: (0, i18n_1.t)("Mikrofon se nepodařilo spustit."),
        message: (0, i18n_1.t)("Zkontrolujte, zda jste v Nastavení povolili aplikaci přístup k mikrofonu."),
    },
    UserCanceledSelection: {
        title: (0, i18n_1.t)("Spárování nové lampy se nezdařilo"),
        message: (0, i18n_1.t)("Pro připojení již spárované lampy prosím stiskněte jakýkoli symbol") + ' "🛑"',
    },
};

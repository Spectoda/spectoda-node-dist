...
class NodeBLEConnection {
    ...
    attach(service, networkUUID, clockUUID, deviceUUID) {
        ...
        return this.#service
            ...
            .then(characteristic => {
            Logging_js_1.logging.info("#networkChar", characteristic);
            ...
            .then(characteristic => {
            Logging_js_1.logging.info("#clockChar", characteristic);
            ...
            .then(characteristic => {
            Logging_js_1.logging.info("#deviceChar", characteristic);

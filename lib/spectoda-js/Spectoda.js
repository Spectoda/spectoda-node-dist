...
class Spectoda {
    ...
    writeControllerName(name) {
        Logging_js_1.logging.debug("> Writing Controller Name...");
        const request_uuid = this.#getUUID();
    ...
    readControllerName() {
        Logging_js_1.logging.debug("> Reading Controller Name...");
        const request_uuid = this.#getUUID();

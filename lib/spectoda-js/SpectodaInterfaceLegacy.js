...
class SpectodaInterfaceLegacy {
    ...
    requestWakeLock() {
        Logging_js_1.logging.info("> Activating wakeLock...");
        if ((0, functions_js_1.detectSpectodaConnect)()) {
    ...
    releaseWakeLock() {
        Logging_js_1.logging.info("> Deactivating wakeLock...");
        if ((0, functions_js_1.detectSpectodaConnect)()) {
                        ...
                        switch (item.type) {
                            ...
                            case Query.TYPE_CONNECT:
                                ...
                                await this.connector
                                    ...
                                    .then(device => {
                                    Logging_js_1.logging.info("> Device connected");
                                    if (!this.#connectGuard) {
                                    ...
                                    Logging_js_1.logging.info("> Requesting clock");
